...
const RegisterForExperience = ({ experience }: { experience: IEvent }) => {
  ...
  const pelicanAvailable = type === "hybrid" || type === "pelican_verified";
  ...
  return (
    <div className="mx-auto w-full 2xl:max-w-2xl">
      <div className="space-y-6 rounded-3xl border border-gray-200 p-6">
        ...
        {pelicanAvailable && (
          <div className="flex w-full flex-col items-center justify-center space-y-4">
            <div className="flex w-full flex-col items-center justify-center rounded-2xl border border-green-200 bg-green-50 p-4 text-center text-sm">
              <p className="text-md font-bold text-green-700">
                Check-in at events 10× faster with Pelican
              </p>
              <p className="mt-1 text-xs text-gray-600">
                Skip manual check-ins today and in future events when you
