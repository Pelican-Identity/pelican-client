  ...
  return (
    <div>
      ...
      <div className="mx-auto max-w-5xl">
        {/* Hero Section */}
        <section className="flex min-h-screen items-center px-6 pt-10 pb-16">
          <div className="grid items-center gap-12 lg:grid-cols-2 lg:gap-16">
            ...
            <div className="order-2 lg:order-1">
              ...
              >
                Pelican Vault is your personal identity app. It stores the
                details you choose to keep, protects them with military-grade
                security, and lets you share them safely with businesses, apps,
                and institutions — only when you decide.
              </motion.p>
        ...
        <section className="bg-card/30 px-2 py-20 md:px-6">
        ...
        <section className="bg-secondary/10 mb-10 flex items-center justify-center">
          <div className="container mx-auto max-w-4xl px-6 py-28 text-center">
            ...
            >
              ...
              <p className="text-muted-foreground mx-auto mb-8 max-w-3xl text-lg">
                ...
                identity becomes your strongest currency. Pelican Vault gives
                you a single, protected, self-owned identity that works
                everywhere — without giving up your privacy.
              </p>
